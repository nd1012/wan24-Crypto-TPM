        ...
        : DisposableBase()
    {
        ...
        public byte[] GetStorableValue()
        {
            ...
            return UseTpmValueProtection
                ? TpmValueProtection.Protect(secureValue.Array, ValueProtection.Scope.Process)
                : ValueProtection.Protect(secureValue.Array, ValueProtection.Scope.Process);
        }
        ...
        public static TpmProcessSecret FromStoredValue(
            ...
            => new(
                ...
                useTpmValueProtection ?? DefaultUseTpmValueProtection
                    ? TpmValueProtection.Unprotect(value, ValueProtection.Scope.Process)
                    : ValueProtection.Unprotect(value, ValueProtection.Scope.Process),
                encryptTimeout,
                recryptTimeout,
                tpmOptions,
                options
